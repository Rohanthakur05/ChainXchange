            ...
            <ErrorBoundary>
                <Router>
                    <Routes>
                        ...
                        */}
                        {isAuthenticated ? (
                            <Route element={<WalletProvider><WatchlistProvider><OnboardingProvider><AuthenticatedRoutes /><OnboardingTour /></OnboardingProvider></WatchlistProvider></WalletProvider>}>
